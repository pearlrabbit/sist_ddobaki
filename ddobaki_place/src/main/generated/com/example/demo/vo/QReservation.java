...
public class QReservation extends EntityPathBase<Reservation> {
    ...
    public final DateTimePath<java.util.Date> reservation_checkin_date = createDateTime("reservation_checkin_date", java.util.Date.class);

    public final DateTimePath<java.util.Date> reservation_checkout_date = createDateTime("reservation_checkout_date", java.util.Date.class);
